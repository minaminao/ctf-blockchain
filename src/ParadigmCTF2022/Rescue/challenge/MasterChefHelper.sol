...
contract MasterChefHelper {
    ...
    function swapTokenForPoolToken(uint256 poolId, address tokenIn, uint256 amountIn, uint256 minAmountOut) external {
        ...
        console.log(tokenIn, ERC20Like(tokenIn).balanceOf(address(this)));
        console.log(tokenOut0, ERC20Like(tokenOut0).balanceOf(address(this)));
        console.log(tokenOut1, ERC20Like(tokenOut1).balanceOf(address(this)));
