...
contract Setup {
    ...
    constructor() payable {
        ...
        diamondLoupeSelectors[0] = bytes4(hex"cdffacc6"); // facetAddress(bytes4)
        diamondLoupeSelectors[1] = bytes4(hex"52ef6b2c"); // facetAddresses()
        diamondLoupeSelectors[2] = bytes4(hex"adfca15e"); // facetFunctionSelectors(address)
        diamondLoupeSelectors[3] = bytes4(hex"7a0ed627"); // facets()
        diamondLoupeSelectors[4] = bytes4(hex"01ffc9a7"); // supportsInterface(bytes4)
        ...
        ownershipFacetSelectors[0] = bytes4(hex"8da5cb5b"); // owner()
        ownershipFacetSelectors[1] = bytes4(hex"f2fde38b"); // transferOwnership(address)
        ...
        daoFacetSelectors[1] = bytes4(hex"0d61b519"); // executeProposal(uint256)
        daoFacetSelectors[2] = bytes4(hex"ece40cc1"); // setProposalThreshold(uint256)
        daoFacetSelectors[3] = bytes4(hex"abdc14c5"); // submitProposal(address _target, bytes memory _callData, IDiamondCut.FacetCut memory _facetDetails)
